...
<main>
	<div id="blueChecker"></div>
	<div id="redChecker"></div>
	<div class="section" id="header">
		...
		<div id="Dates" style="text-align: center">April 8 - 10</div>
	</div>
	<div class="section" id="form">
		<form on:submit={handleOnSubmit}>
			...
			<div>
				<label for="phone-number" class="question">Phone number</label>
				<input
					type="tel"
					id="phone-number"
					name="phone-number"
			...
			<div>
				<label for="birthdate" class="question">Birthdate</label>
			...
			<div>
				<label for="race" class="question">Race (select all that apply)</label>
				<input type="checkbox" id="race" name="race" value="native">
				<label for="race">American Indian or Alaska Native</label><br>
				<input type="checkbox" id="race" name="race" value="asian">
				<label for="race">Asian</label><br>
				<input type="checkbox" id="race" name="race" value="black">
				<label for="race">Black or African American</label><br>
				<input type="checkbox" id="race" name="race" value="pacific">
				<label for="race">Native Hawaiian or Other Pacific Islander</label><br>
				<input type="checkbox" id="race" name="race" value="white">
				<label for="race">White</label><br>
				<input type="checkbox" id="race" name="race" value="prefer-not">
				<label for="race">Prefer not to answer</label><br>
			</div>
			<div>
				<label for="ethnicity" class="question">Are you Hispanic or Latino?</label>
				<input type="radio" id="yes" name="ethnicity" value="yes">
				<label for="male">Yes</label><br>
				<input type="radio" id="no" name="ethnicity" value="no">
				<label for="male">No</label><br>
				<input type="radio" id="prefer-not" name="ethnicity" value="prefer-not">
				<label for="male">Prefer not to answer</label><br>
			</div>
			<div>
				<label for="school" class="question">School</label>
				<input
					type="text"
					id="school"
					name="school"
			...
			<div>
				<label for="level-of-study" class="question">Level of study</label>
				<input type="radio" id="freshman" name="level-of-study" value="freshman">
				<label for="freshman">Freshman</label><br>
				<input type="radio" id="sophomore" name="level-of-study" value="sophomore">
				<label for="freshman">Sophomore</label><br>
				<input type="radio" id="junior" name="level-of-study" value="junior">
				<label for="freshman">Junior</label><br>
				<input type="radio" id="senior" name="level-of-study" value="senior">
				<label for="freshman">Senior</label><br>
				<input type="radio" id="grad-student" name="level-of-study" value="grad-student">
				<label for="freshman">Graduate Student</label><br>
			</div>
			<div>
				<label for="grad-year" class="question">Graduation year</label>
				<input type="month" id="grad-year" name="grad-year">
			</div>
			<div>
				<label for="major" class="question">Major</label>
				<input
					type="text"
					id="major"
					name="major"
			...
			<div>
				<label for="hackathons" class="question">How many hackathons have you attended previously?</label>
				<input
					type="number"
					id="hackathons"
					name="hackathons"
			...
			<div>
				<label for="size" class="question">Shirt size</label>
			...
			<div>
				<label for="food" class="question">Food allergies</label>
				<input
					type="text"
					id="food"
					name="food"
			...
			<div>
				<label for="resume" class="question">Resume</label>
				<input
					type="file"
					id="resume"
					name="resume"
